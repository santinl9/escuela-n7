...
import * as cargaNumericaService from "../services/cargaNumerica.service";
...
export async function getAll(req: Request, res: Response) {
  ...
  const datos = await cargaNumericaService.getAll(alcance);
...
export async function getById(req: Request, res: Response) {
  ...
  const alcance = await alcanceDe(req.usuario);
  const dato = await cargaNumericaService.getById(id, alcance);
  return res.status(200).json(dato);
}

export async function create(req: Request, res: Response) {
  const creado = await cargaNumericaService.create(req.body);
...
export async function update(req: Request, res: Response) {
  const id = Number(req.params.id);
  const alcance = await alcanceDe(req.usuario);
  const actualizado = await cargaNumericaService.update(id, req.body, alcance);
...
export async function remove(req: Request, res: Response) {
  const id = Number(req.params.id);
  const alcance = await alcanceDe(req.usuario);
  const eliminado = await cargaNumericaService.remove(id, alcance);
